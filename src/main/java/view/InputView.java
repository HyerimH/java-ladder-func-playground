...
public class InputView {
  ...
  public static final String INPUT_EXCEPTION_MESSAGE = "올바른 입력 형식이 아닙니다. 다시 입력해주세요.";
  ...
  public List<String> inputGoals(Players players) {
    System.out.println("\n" + EXECUTION_GOAL_MESSAGE);
